...
- (void)selectedPhotoAction:(UIImage *)image {
    ...
    [self.cancelButton setImage:[UIImage imageNamed:@"cancel" inBundle:[NSBundle.alloc initWithPath:[NSBundle.mainBundle pathForResource:@"PEPImageDoodleBoard" ofType:@"bundle"]] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [self.view addSubview:self.cancelButton];
    
    self.chooseButton = [[UIButton alloc] initWithFrame:CGRectMake(WIDTH / 2 - 37, HEIGHT - 80 - 37, 74, 74)];
    [self.chooseButton setImage:[UIImage imageNamed:@"white_circle" inBundle:[NSBundle.alloc initWithPath:[NSBundle.mainBundle pathForResource:@"PEPImageDoodleBoard" ofType:@"bundle"]] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
...
- (UIButton *)exitButton {
    if (!_exitButton) {
        ...
        [_exitButton setBackgroundImage:[UIImage imageNamed:@"pull_down" inBundle:[NSBundle.alloc initWithPath:[NSBundle.mainBundle pathForResource:@"PEPImageDoodleBoard" ofType:@"bundle"]] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    }
    return _exitButton;
}
...
- (UIButton *)takePhotoButton {
    if (!_takePhotoButton) {
        ...
        [_takePhotoButton setBackgroundImage:[UIImage imageNamed:@"button" inBundle:[NSBundle.alloc initWithPath:[NSBundle.mainBundle pathForResource:@"PEPImageDoodleBoard" ofType:@"bundle"]] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    }
...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        ...
        [_cancelButton setImage:[UIImage imageNamed:@"cancel" inBundle:[NSBundle.alloc initWithPath:[NSBundle.mainBundle pathForResource:@"PEPImageDoodleBoard" ofType:@"bundle"]] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    }
...
- (UIButton *)chooseButton {
    if (!_chooseButton) {
        ...
        [_chooseButton setImage:[UIImage imageNamed:@"white_circle" inBundle:[NSBundle.alloc initWithPath:[NSBundle.mainBundle pathForResource:@"PEPImageDoodleBoard" ofType:@"bundle"]] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    }
...
- (UIButton *)switchCameraButton {
    if (!_switchCameraButton) {
        ...
        [_switchCameraButton setImage:[UIImage imageNamed:@"change_direction" inBundle:[NSBundle.alloc initWithPath:[NSBundle.mainBundle pathForResource:@"PEPImageDoodleBoard" ofType:@"bundle"]] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    }
